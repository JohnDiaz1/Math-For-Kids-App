...
import com.towo.AnimalesApp.databinding.MultiplicacionJuegoBinding
import java.util.*

class Multiplicacion : Fragment(), RewardedVideoListener  {
    ...
    private var _binding: MultiplicacionJuegoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MultiplicacionJuegoBinding.inflate(layoutInflater, container, false)
