...
class Sumas : Fragment(), RewardedVideoListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.sumas_juego, container, false)
    }
            ...
            when (choiceButton) {
                0 -> {
                    activity?.runOnUiThread {
                        ...
                        res2.text = rdmButton[1].toString()
                        res3.text = rdmButton[2].toString()
                    }
                }
                1 -> {
                    activity?.runOnUiThread {
                        res2.text = resultado.toString()
                        res1.text = rdmButton[1].toString()
                        res3.text = rdmButton[2].toString()
                    }
                }
                else -> {
                    activity?.runOnUiThread {
                        ...
                        res2.text = rdmButton[1].toString()
                        res1.text = rdmButton[2].toString()
                    }
                }
            }
        }.start()
