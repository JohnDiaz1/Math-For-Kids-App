...
import com.towo.AnimalesApp.databinding.DivisionJuegoBinding
import java.util.*
...
class Division : Fragment(), RewardedVideoListener {
    ...
    private var _binding: DivisionJuegoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DivisionJuegoBinding.inflate(layoutInflater, container, false)
